...
export function BuildingIllustration({ className = "" }) {
	return (
		<div className={`relative rounded-full flex justify-center items-center overflow-hidden invert ${className}`}>
			<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
				width="260" height="220" viewBox="0 0 300.000000 260.000000"
